...
<div class="goods-contain">
  ...
  <div class="goods-items">
    <ul class="price-inter">
      ...
      <li class="price-item" :class="{active: priceLevel === index}" v-for="(item, index) in price" @click="selectInter(index)" :key="index">{{item.startPrice}}-{{item.endPrice}}</li>
    </ul>
    <ul class="goods-info">
    ...
    <my-dialog :is-show="showAddCart" @on-close="closeCart()">
      <div class="dialog-cart">
        ...
        <div class="btn-contain">
          ...
          <router-link tag="button" to="orderConfirm" class="cart-in dialog-btn">去结算</router-link>
        </div>
      </div>
    </my-dialog>
